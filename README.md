...
| 타임라인             | 추가 기능 | 세부 계획 |
| ----------------- | ---------------- | --------- |
| 2023.07.02        | 단어 검색 기능 추가   | 1. 단어 로드가 완료되면 트라이 자료구조에 영어 단어를 저장한다 <br/> 2. 유저가 찾는 단어와 가장 유사한 영어단어 5개를 보여준다 |                                  
| 2023.07.23         | 유저 학습 경험 개선   | 1. 퀴즈 결과 데이터 저장를 퀴즈 테이블에 저장한다 <br/> 2. 유저 단어장 커스텀 기능을 추가한다 |
